...
public:
	...
	ClickableBitmap(const AllegroCPP::Bitmap& body_src, int draw_x, int draw_y, int w, int h, std::vector<bitmap_cuts> cuts, c_state_action_map do_map, c_state_trig_fcn_map_auto fcn_map = {});
	~ClickableBitmap();
